...
InjectCors.addHeadersToResponse = function(headers, request){
  ...
  try {
    var acceptedHeaders = request.getRequestHeader('Access-Control-Request-Headers');
    request.setResponseHeader("Access-Control-Allow-Headers", acceptedHeaders, false);
  }
  catch(e){
  }
};
